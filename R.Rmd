...
Creamos los conjuntos de train, validation y test para los 3 sets nuevos y hacemos grid search para cada uno. Al conjunto de validación le asignamos los del conjunto de validación sin missings, dado que no es posible sino calcular el AUC sobre este modelo.
```{r , echo=FALSE}
# Set 20% missings
