...
Creamos los conjuntos de train, validation y test para los 3 sets nuevos y hacemos grid search para cada uno. Sin embargo, al conjunto de validación le asignamos los del conjunto de validación sin missings, dado que no es posible sino calcular el AUC sobre este modelo.
```{r , echo=FALSE}
# Set 20% missings
train_20 <- datos_20[train_idx, ]
valid_20 <- datos_20[valid_idx, ]
valid_20$loan_status <- valid$loan_status
...
aucs_caluclados_20 <- mejor_arbol_20[5:length(mejor_arbol_20)]
```
...
valid_50$loan_status <- valid$loan_status
test_50 <- datos_50[test_idx, ]

mejor_arbol_50 <- gridSearch(train_50,valid_50,25,35,10)
mej_auc_50 = mejor_arbol_50[1]
mej_maxd_50 = mejor_arbol_50[2]
mej_mins_50 = mejor_arbol_50[3]
mej_minb_50 = mejor_arbol_50[4]
aucs_caluclados_50 <- mejor_arbol_50[5:length(mejor_arbol_50)]
```
...
valid_75$loan_status <- valid$loan_status
test_75 <- datos_75[test_idx, ]

mejor_arbol_75 <- gridSearch(train_75,valid_75,25,35,10)
mej_auc_75 = mejor_arbol_75[1]
mej_maxd_75 = mejor_arbol_75[2]
mej_mins_75 = mejor_arbol_75[3]
mej_minb_75 = mejor_arbol_75[4]
aucs_caluclados_75 <- mejor_arbol_75[5:length(mejor_arbol_75)]
```
